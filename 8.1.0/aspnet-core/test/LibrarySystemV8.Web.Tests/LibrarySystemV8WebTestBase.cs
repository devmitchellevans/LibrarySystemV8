...
{
    public abstract class LibrarySystemV8WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibrarySystemV8WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibrarySystemV8WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibrarySystemV8DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibrarySystemV8DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibrarySystemV8DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibrarySystemV8DbContext, Task<T>> func)
        {
            T result;
